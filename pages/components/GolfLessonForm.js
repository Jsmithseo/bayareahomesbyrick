...
const GolfLessonForm = () => {
  ...
  const handleChange = (e) => {
    ...
    if (type === 'checkbox') {
      if (checked) {
        ...
        setFormData({
          ...formData,
          daysForLessons: formData.daysForLessons.filter((day) => day !== value),
        });
      }
    } else {
  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      <FormGroup>
        ...
        <div>
          ...
          <CustomInput
            ...
            checked={formData.howDidYouHear === 'Drive-by/Walk-by The Golf Spot'}
            onChange={handleChange}
          />
          <CustomInput
            type="radio"
      ...
      <FormGroup>
        <Label for="whyGetLessons">What made you think about getting lessons?</Label>
        <Textarea
          type="text"
          name="whyGetLessons"
          id="whyGetLessons"
      ...
      <FormGroup>
        <Label for="yearsPlayingGolf">How long have you been playing golf?</Label>
        <Input
          type="text"
      ...
      <FormGroup>
        <Label for="daysPracticed">How many days a week do you practice?</Label>
        <Input
          type="text"
          name="daysPracticed"
          id="daysPracticed"
      ...
      <FormGroup>
        <Label for="roundsPerMonth">How many rounds of golf do you play per month?</Label>
        <Input
          type="text"
          name="roundsPerMonth"
          id="roundsPerMonth"
      ...
      <FormGroup>
        <Label for="frustrations">What are your frustrations with your game?</Label>
        <Textarea
          type="text"
          name="frustrations"
          id="frustrations"
